...
if ( ! function_exists( 'festate_setup' ) ) :
	...
	function festate_setup() {
		...
		$starter_content = array(
			...
			'attachments' => array(
				'image-slide-1' => array(
					'post_title' => _x( 'Slider Image 1', 'Theme starter content', 'festate' ),
					'file' => 'images/slider/1.jpg', // URL relative to the template directory.
				),
				'image-slide-2' => array(
					'post_title' => _x( 'Slider Image 2', 'Theme starter content', 'festate' ),
					'file' => 'images/slider/2.jpg', // URL relative to the template directory.
				),
				'image-slide-3' => array(
					'post_title' => _x( 'Slider Image 3', 'Theme starter content', 'festate' ),
			...
			'theme_mods' => array(
				...
				'festate_slide1_image' => '{{image-slider-1}}',
				'festate_slide2_image' => '{{image-slider-2}}',
				'festate_slide3_image' => '{{image-slider-3}}',
			),
